...
RSpec.describe AssocsController, type: :controller do
  ...
  describe 'news' do
  	...
  	# public news
  	FactoryGirl.create(:news, group_id: assoc.id, group_type: "Assoc", as_group: true, volunteer_id: owner.id)
  	FactoryGirl.create(:news, group_id: assoc.id, group_type: "Assoc", as_group: true, volunteer_id: owner.id)

  	# private news
  	FactoryGirl.create(:news, group_id: assoc.id, group_type: "Assoc", as_group: true, volunteer_id: owner.id, private: true)
