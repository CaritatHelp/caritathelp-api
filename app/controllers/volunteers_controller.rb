class VolunteersController < ApplicationController
  ...
  def events
    ...
    events = ActiveRecord::Base.connection.execute(query).map { |e| e.as_json.merge(assoc_name: Assoc.find(e["assoc_id"]).name, begin: e["begin"].to_datetime, end: e["end"].to_datetime) }
